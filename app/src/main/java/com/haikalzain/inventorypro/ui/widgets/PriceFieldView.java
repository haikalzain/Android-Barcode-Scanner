 ...
 */
public class PriceFieldView extends FieldView{
    private EditText editText;

    public PriceFieldView(Context context, String label, boolean isFilterView) {
    ...
    public void setInputViewValue(String dataString) {
        editText.setText(String.format("%01.2f", Double.parseDouble(dataString)));
    }
    ...
    protected String getInputDataString() {
        ...
        return String.format("%01.2f", Double.parseDouble(raw));
    }
}
